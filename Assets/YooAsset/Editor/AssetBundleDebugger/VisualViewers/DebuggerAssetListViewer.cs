...
namespace YooAsset.Editor
{
    internal class DebuggerAssetListViewer
    {
        ...
        private void CreateAssetTableViewColumns()
        {
            ...
            // Status
            {
                ...
                column.BindCell = (VisualElement element, ITableData data, ITableCell cell) =>
                {
                    ...
                    if (providerTableData.ProviderInfo.Status == Common.EOperationStatus.Failed.ToString())
        ...
        private void CreateDependTableViewColumns()
        {
            ...
            // Status
            {
                ...
                column.BindCell = (VisualElement element, ITableData data, ITableCell cell) =>
                {
                    ...
                    if (dependTableData.BundleInfo.Status == Common.EOperationStatus.Failed.ToString())
                        textColor = new StyleColor(Color.yellow);
                    else
                        textColor = new StyleColor(Color.white);
        ...
        {
            var providerTableData = data as ProviderTableData;
            Common.DebugPackageData packageData = providerTableData.PackageData;
            Common.DebugProviderInfo providerInfo = providerTableData.ProviderInfo;
